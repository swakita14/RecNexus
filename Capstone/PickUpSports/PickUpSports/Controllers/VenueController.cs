...
namespace PickUpSports.Controllers
{
    public class VenueController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var mostRecentUpdate = _context.Venues.OrderByDescending(v => v.DateUpdated).FirstOrDefault();
        ...
        private void UpdatePlaceDetails()
        {
            ...
            foreach (var venue in venuesWithoutDetails)
            {
                ...
                var venueDetails = _placesApi.GetPlaceDetailsById(venue.GooglePlaceId).Result;
